...
{/* 
                ...
                <div className="flex pt-[31px]">
                  ...
                  <div className="flex flex-col">
                     <div className="mb-2 block text-emphasis text-sm font-semibold leading-none">
                     Session timeout
                     </div>
                      <div className="text-default -mt-1.5 text-sm leading-normal">
                      Invalidate your session after a certain amount of time.
                      </div>
                  </div>
