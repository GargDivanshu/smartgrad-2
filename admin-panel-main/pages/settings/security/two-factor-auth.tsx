    ...
    return (
        <SettingsWrapper>
            <>
                ...
                {/* <div className="flex Inter mb-4 max-w-[606px]"> */}
                {/* <div className='mt-2 pr-3 w-1/2'>
                    ...
                    <div className="flex rounded-md">
                        <div className='w-full relative'>
                            ...
                            placeholder='Old Password'
                                className="hover:border-emphasis border-default bg-default placeholder:text-muted text-emphasis disabled:hover:border-default min-h-9 disabled:bg-subtle block py-2 px-3 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1 disabled:cursor-not-allowed w-full mb-0 mt-0 rounded-md rounded-r-none font-sans text-sm leading-4 focus:!ring-0 border focus:border border-r-default"
                            />
                        </div>
                        <span className="border-default bg-muted text-subtle hidden h-10 items-center rounded-r-md border border-l-0 px-3 text-sm md:inline-flex">
                            <FiEye
...
{/*                 
                ...
                {/* <div className="text-default border-b-default border-b-[1px] pb-4 max-w-[38rem] text-sm">
...
{/* 
                ...
                <div className="flex pt-[31px]">
                  ...
                  <div className="flex flex-col">
                    <div className="flex">
                     <div className="mb-2 block text-[#374151] text-base font-semibold leading-none">
                     Two factor authentication
                     </div>
                     <div className="font-medium inline-flex items-center justify-center rounded gap-x-1 bg-subtle text-emphasis py-1 px-1.5 mx-2 text-xs">
                        Disabled
                     </div>
                     </div>
                      <div className="text-default -mt-1 text-sm leading-normal">
